            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**Asisstant Qrupa Qoşuldu**")

                except UserAlreadyParticipant:
                    pass
                except Exception:
                    await lel.edit(
                        f"Assistantın banını açın\nİstifadəçi adı: @SecretAsistan\nKöməkçi ID: `1986176004`")
    try:
    ...
    if audio:
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                      [
            [
                InlineKeyboardButton("✅ Digər Botlar", url=f"https://t.me/bossbotsaz"),
                InlineKeyboardButton("🆘 Support", url=f"https://t.me/bossbotsazhelp"),
            ],[
